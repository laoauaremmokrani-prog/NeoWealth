...
Rebuilt from scratch - clean, no crashes.
"""
...
class MLPPredictor:
    ...
    def __init__(self):
        ...
        self.model_path = Path(__file__).parent.parent / "models" / "mlp_model.keras"
    ...
    def predict(self, features: list) -> Dict[str, Any]:
        ...
        Args:
            features: List of 5 values [inflation, interest, unemployment, GDP, sp500]
        ...
        # TODO: Use saved scaler if available
...
def predict_from_features(features: list) -> Dict[str, Any]:
    """
    Convenience function to predict from features.
